use crate::lib;
mockall::mock! {
    pub Mq {} impl crate ::Exits for Mq { unsafe fn MQXEP < 'c, 'b, 'a > (& self, Hconfig
    : lib::MQHCONFIG, ExitReason : lib::MQLONG, Function : lib::MQLONG, pEntryPoint :
    lib::PMQFUNC, pExitOpts : Option < & 'a lib::MQXEPO >, pCompCode : & 'b mut
    lib::MQLONG, pReason : & 'c mut lib::MQLONG) {} unsafe fn MQXCLWLN < 'd, 'c, 'b, 'a >
    (& self, pExitParms : & 'a mut lib::MQWXP, CurrentRecord : lib::MQPTR, NextOffset :
    lib::MQLONG, pNextRecord : & 'b mut lib::MQPTR, pCompCode : & 'c mut lib::MQLONG,
    pReason : & 'd mut lib::MQLONG) {} unsafe fn MQXCNVC < 'c, 'b, 'a > (& self, Hconn :
    lib::MQHCONN, Options : lib::MQLONG, SourceCCSID : lib::MQLONG, SourceLength :
    lib::MQLONG, pSourceBuffer : lib::PMQCHAR, TargetCCSID : lib::MQLONG, TargetLength :
    lib::MQLONG, pTargetBuffer : lib::PMQCHAR, pDataLength : & 'a mut lib::MQLONG,
    pCompCode : & 'b mut lib::MQLONG, pReason : & 'c mut lib::MQLONG) {} unsafe fn MQXDX
    < 'a > (& self, pDataConvExitParms : & 'a mut lib::MQDXP, pMsgDesc : lib::PMQMD,
    InBufferLength : lib::MQLONG, pInBuffer : lib::PMQVOID, OutBufferLength :
    lib::MQLONG, pOutBuffer : lib::PMQVOID) {} unsafe fn MQZEP < 'b, 'a > (& self,
    Hconfig : lib::MQHCONFIG, Function : lib::MQLONG, pEntryPoint : lib::PMQFUNC,
    pCompCode : & 'a mut lib::MQLONG, pReason : & 'b mut lib::MQLONG) {} } impl crate
    ::Mqai for Mq { unsafe fn mqAddBag < 'b, 'a > (& self, Bag : lib::MQHBAG, Selector :
    ...
    lib::MQLONG, pReason : & 'd mut lib::MQLONG) {} unsafe fn mqInquireStringFilter < 'e,
    'd, 'c, 'b, 'a > (& self, Bag : lib::MQHBAG, Selector : lib::MQLONG, ItemIndex :
    ...
    mut lib::MQLONG) {} unsafe fn mqPutBag < 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN,
    Hobj : lib::MQHOBJ, pMsgDesc : lib::PMQVOID, pPutMsgOpts : & 'a mut lib::MQPMO, Bag :
    lib::MQHBAG, pCompCode : & 'b mut lib::MQLONG, pReason : & 'c mut lib::MQLONG) {}
    unsafe fn mqSetByteString < 'b, 'a > (& self, Bag : lib::MQHBAG, Selector :
    lib::MQLONG, ItemIndex : lib::MQLONG, BufferLength : lib::MQLONG, pBuffer :
    lib::PMQBYTE, pCompCode : & 'a mut lib::MQLONG, pReason : & 'b mut lib::MQLONG) {}
    ...
    unsafe fn MQCRTMH < 'd, 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, pCrtMsgHOpts : &
    'a lib::MQCMHO, pHmsg : & 'b mut lib::MQHMSG, pCompCode : & 'c mut lib::MQLONG,
    pReason : & 'd mut lib::MQLONG) {} unsafe fn MQCTL < 'c, 'b, 'a > (& self, Hconn :
    lib::MQHCONN, Operation : lib::MQLONG, pControlOpts : & 'a lib::MQCTLO, pCompCode : &
    'b mut lib::MQLONG, pReason : & 'c mut lib::MQLONG) {} unsafe fn MQDISC < 'c, 'b, 'a
    > (& self, pHconn : & 'a mut lib::MQHCONN, pCompCode : & 'b mut lib::MQLONG, pReason
    : & 'c mut lib::MQLONG) {} unsafe fn MQDLTMH < 'd, 'c, 'b, 'a > (& self, Hconn :
    lib::MQHCONN, pHmsg : & 'a mut lib::MQHMSG, pDltMsgHOpts : & 'b lib::MQDMHO,
    pCompCode : & 'c mut lib::MQLONG, pReason : & 'd mut lib::MQLONG) {} unsafe fn
    MQDLTMP < 'd, 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, Hmsg : lib::MQHMSG,
    pDltPropOpts : & 'a lib::MQDMPO, pName : & 'b lib::MQCHARV, pCompCode : & 'c mut
    lib::MQLONG, pReason : & 'd mut lib::MQLONG) {} unsafe fn MQGET < 'd, 'c, 'b, 'a > (&
    self, Hconn : lib::MQHCONN, Hobj : lib::MQHOBJ, pMsgDesc : lib::PMQVOID, pGetMsgOpts
    : & 'a mut lib::MQGMO, BufferLength : lib::MQLONG, pBuffer : lib::PMQVOID,
    pDataLength : & 'b mut lib::MQLONG, pCompCode : & 'c mut lib::MQLONG, pReason : & 'd
    mut lib::MQLONG) {} unsafe fn MQINQ < 'b, 'a > (& self, Hconn : lib::MQHCONN, Hobj :
    ...
    unsafe fn MQINQMP < 'g, 'f, 'e, 'd, 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, Hmsg
    : lib::MQHMSG, pInqPropOpts : & 'a mut lib::MQIMPO, pName : & 'b lib::MQCHARV,
    pPropDesc : & 'c mut lib::MQPD, pType : & 'd mut lib::MQLONG, ValueLength :
    lib::MQLONG, pValue : lib::PMQVOID, pDataLength : & 'e mut lib::MQLONG, pCompCode : &
    'f mut lib::MQLONG, pReason : & 'g mut lib::MQLONG) {} unsafe fn MQMHBUF < 'e, 'd,
    'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, Hmsg : lib::MQHMSG, pMsgHBufOpts : & 'a
    lib::MQMHBO, pName : & 'b lib::MQCHARV, pMsgDesc : lib::PMQVOID, BufferLength :
    lib::MQLONG, pBuffer : lib::PMQVOID, pDataLength : & 'c mut lib::MQLONG, pCompCode :
    & 'd mut lib::MQLONG, pReason : & 'e mut lib::MQLONG) {} unsafe fn MQOPEN < 'd, 'c,
    'b, 'a > (& self, Hconn : lib::MQHCONN, pObjDesc : & 'a mut lib::MQOD, Options :
    lib::MQLONG, pHobj : & 'b mut lib::MQHOBJ, pCompCode : & 'c mut lib::MQLONG, pReason
    : & 'd mut lib::MQLONG) {} unsafe fn MQPUT < 'c, 'b, 'a > (& self, Hconn :
    lib::MQHCONN, Hobj : lib::MQHOBJ, pMsgDesc : lib::PMQVOID, pPutMsgOpts : & 'a mut
    lib::MQPMO, BufferLength : lib::MQLONG, pBuffer : lib::PMQVOID, pCompCode : & 'b mut
    lib::MQLONG, pReason : & 'c mut lib::MQLONG) {} unsafe fn MQPUT1 < 'd, 'c, 'b, 'a >
    (& self, Hconn : lib::MQHCONN, pObjDesc : & 'a mut lib::MQOD, pMsgDesc :
    lib::PMQVOID, pPutMsgOpts : & 'b mut lib::MQPMO, BufferLength : lib::MQLONG, pBuffer
    : lib::PMQVOID, pCompCode : & 'c mut lib::MQLONG, pReason : & 'd mut lib::MQLONG) {}
    unsafe fn MQSET < 'b, 'a > (& self, Hconn : lib::MQHCONN, Hobj : lib::MQHOBJ,
    SelectorCount : lib::MQLONG, pSelectors : lib::PMQLONG, IntAttrCount : lib::MQLONG,
    pIntAttrs : lib::PMQLONG, CharAttrLength : lib::MQLONG, pCharAttrs : lib::PMQCHAR,
    pCompCode : & 'a mut lib::MQLONG, pReason : & 'b mut lib::MQLONG) {} unsafe fn
    MQSETMP < 'e, 'd, 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, Hmsg : lib::MQHMSG,
    pSetPropOpts : & 'a lib::MQSMPO, pName : & 'b lib::MQCHARV, pPropDesc : & 'c mut
    lib::MQPD, Type : lib::MQLONG, ValueLength : lib::MQLONG, pValue : lib::PMQVOID,
    pCompCode : & 'd mut lib::MQLONG, pReason : & 'e mut lib::MQLONG) {} unsafe fn MQSTAT
    < 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, Type : lib::MQLONG, pStatus : & 'a mut
    lib::MQSTS, pCompCode : & 'b mut lib::MQLONG, pReason : & 'c mut lib::MQLONG) {}
    unsafe fn MQSUB < 'e, 'd, 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, pSubDesc : & 'a
    mut lib::MQSD, pHobj : Option < & 'b mut lib::MQHOBJ >, pHsub : & 'c mut lib::MQHOBJ,
    pCompCode : & 'd mut lib::MQLONG, pReason : & 'e mut lib::MQLONG) {} unsafe fn
    MQSUBRQ < 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, Hsub : lib::MQHOBJ, Action :
    lib::MQLONG, pSubRqOpts : Option < & 'a mut lib::MQSRO >, pCompCode : & 'b mut
    lib::MQLONG, pReason : & 'c mut lib::MQLONG) {} }
}
