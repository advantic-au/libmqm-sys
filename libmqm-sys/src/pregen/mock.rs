...
mockall::mock! {
    ...
    MQSTAT < 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, Type : lib::MQLONG, pStatus : &
    'a mut lib::MQSTS, pCompCode : & 'b mut lib::MQLONG, pReason : & 'c mut lib::MQLONG)
    {} unsafe fn MQSUB < 'e, 'd, 'c, 'b, 'a > (& self, Hconn : lib::MQHCONN, pSubDesc : &
    'a mut lib::MQSD, pHobj : Option < & 'b mut lib::MQHOBJ >, pHsub : & 'c mut
