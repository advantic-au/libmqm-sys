use crate::lib;
mockall::mock! {
    pub Mq {} #[cfg(feature = "exits")] impl crate ::Exits for Mq { unsafe fn MQXEP < 'c,
    'b, 'a > (& self, Hconfig : lib::MQHCONFIG, ExitReason : lib::MQLONG, Function :
    lib::MQLONG, pEntryPoint : lib::PMQFUNC, pExitOpts : Option < & 'a lib::MQXEPO >,
    ...
    lib::MQLONG, pReason : & 'c mut lib::MQLONG) {} unsafe fn MQXCNVC < 'c, 'b, 'a > (&
