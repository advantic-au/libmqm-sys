...
unsafe extern "C" {
    ...
    pub fn MQNHACONNGRP_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub fn MQNHAGRPROLE_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub fn MQNHAINSYNC_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub fn MQNHAROLE_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub fn MQNHASTATUS_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub fn MQNHATYPE_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    ...
    pub fn MQ_HTTPSCERTREV_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub fn MQ_HTTPSCERTVAL_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub fn MQ_MQTT_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub fn MQ_SUITE_STR(v: MQLONG) -> *mut ::std::os::raw::c_char;
    pub static MQI_BY_VALUE_STR: [MQI_BY_VALUE_STR; 5301usize];
    pub static MQI_BY_NAME_STR: [MQI_BY_NAME_STR; 5301usize];
