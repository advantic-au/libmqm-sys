...
pub const MQCACF_MAPSTR: BinarySearchSource = ConstSource(
    ...
    &[(3001, "MQCACF_FIRST"), (3236, "MQCACF_LAST_USED")],
);
...
pub const MQDCC_MAPSTR: LinearSource = ConstSource(
    ...
    &[
        ...
        (16, "MQDCC_SOURCE_ENC_NATIVE"),
        (256, "MQDCC_TARGET_ENC_FACTOR"),
        (256, "MQDCC_TARGET_ENC_NATIVE"),
    ],
);
...
pub const MQERO_MAPSTR: LinearSource = ConstSource(&[(0, "MQERO_NONE")], &[]);
