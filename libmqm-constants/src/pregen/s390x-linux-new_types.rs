...
pub mod constants {
    ...
    pub const MQDCC_SOURCE_ENC_NATIVE: types::MQDCC = types::MQDCC(16);
    pub const MQDCC_TARGET_ENC_FACTOR: types::MQDCC = types::MQDCC(256);
    pub const MQDCC_TARGET_ENC_NATIVE: types::MQDCC = types::MQDCC(256);
    ...
    pub const MQENC_NATIVE: types::MQENC = types::MQENC(273);
