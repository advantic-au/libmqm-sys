...
#[cfg_attr(all(target_os = "linux", target_arch = "powerpc64"), path = "powerpc64-linux-defaults.rs")]
#[cfg_attr(all(target_os = "linux", target_arch = "s390x"), path = "s390x-linux-defaults.rs")]
